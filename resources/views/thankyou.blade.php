...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/images/logos/Logo ENJR.jpg">
    <style>
        .bg-pr-400 {
    ...
    <div class="h-screen bg-gray-200 flex justify-center items-center ">
        <div class="bg-white md:w-3/5 h-4/5 rounded-lg mx-4 shadow-xl flex flex-col justify-start items-center gap-8">
            <div class="w-32 mt-10">
                <img loading="lazy"  src="/images/logos/Logo ENJR.jpg" alt="">
            </div>
            <div class="">
                <h1 class="font-car font-bold text-gray-900 text-6xl text-center">Thank You</h1>
                <p class="font-car text-center">Terima kasih telah memilih dan mempercayai perusahaan mobil kami</p>
            </div>
            <div class="relative bg-gray-200 md:w-3/5 m-4 md:mt-10">
                ...
                <div class="p-3">
                    <h2 class="text-center mt-4 font-medium text-xl">Apa yang harus dilakukan selanjutnya !</h2>
                    <p class="text-lg font-car text-gray-600 text-justify">Anda dapat datang ke salah satu toko kami dekat Anda dan menunjukkan invoice pemesanan Anda (digital atau cetak) dan membayar dan mendapatkan mobil Anda</p>
