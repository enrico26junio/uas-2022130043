            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid mb-32 ">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        <!-- Card -->
                        <a href="{{ route('users') }}">
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs hover:bg-blue-200  ">
                                <div class="p-3 mr-4 bg-blue-500 rounded-full ">
                    ...
                    <div class="mt-12">
                        <div class="flex align-middle justify-center">
                            <hr class=" mt-8 h-0.5 w-1/2 bg-blue-500">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    ...
                                    @forelse ($reservations as $reservation)
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                {{ number_format($reservation->car->price_per_day * $reservation->days, 0, ',', '.') }} Rp
                                            </td>
                                            ...
                                            <td class="px-4 py-3 w-36 text-sm flex flex-col justify-center">
                                                ...
                                                <a class="p-2 mb-1 text-white bg-blue-500 hover:bg-blue-600 font-medium rounded text-center"
                                                    href="{{ route('editStatus', ['reservation' => $reservation->id]) }}">
                                                    <button>Edit Status </button>
                                                </a>

                                                <a class="p-2 mb-1 text-white bg-red-500 hover:bg-indigo-600 font-medium rounded text-center"
