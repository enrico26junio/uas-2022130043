            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ number_format($reservation->price_per_day, 0, ',', '.') }} IDR</td>
                        <td>{{ number_format($reservation->total_price, 0, ',', '.') }} IDR</td>
                    </tr>
        ...
        <div class="inv-footer">
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <th>tax</th>
                        <td>(15%) {{ number_format(intval($reservation->total_price - ($reservation->total_price * 85) / 100), 0, ',', '.') }}  IDR</td>
                    </tr>
                    <tr>
                        <th style="color: #1A202C">Total to pay</th>
                        <td>{{ number_format($reservation->total_price - ($reservation->total_price * 85) / 100 + $reservation->total_price, 0, ',', '.') }}  IDR</td>
                    </tr>
                </table>
            </div>

        </div>
        <h3 style="text-align: center; margin-top: 30px; color: #1A202C">Thank you for choosing and trusting our car company ❤️</h3>
    </div>
    <script>
